...
for i = 1:50
   ...
   try 
   state = importdata([num2str(i) '_out_300_White' num2str(PTZNum) '.mat']);
   catch
       continue;
   end
...
[SimPTZAll, Sim2PTZAll, udAll, ud2All] = ObjFitPTZ(BestFitParams,DataPTZ,bb,aa,ObjNum);
...
save(['Sim2PTZ' num2str(PTZNum) 'All.mat'],'Sim2PTZAll', '-v7.3');
save(['ud2PTZ' num2str(PTZNum) 'All.mat'],'ud2All', '-v7.3');