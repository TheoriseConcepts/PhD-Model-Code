...
for i = 1:50
   ...
   try 
   state = importdata([num2str(i) '_out_300_White' num2str(ControlNum) '.mat']);
   catch
       continue;
   end
...
[SimControlAll, Sim2ControlAll, udAll, ud2All] = ObjFitControl(BestFitParams,DataControl,bb,aa,ObjNum);
...
save(['Sim2Control' num2str(ControlNum) 'All.mat'],'Sim2ControlAll', '-v7.3');
save(['ud2Control' num2str(ControlNum) 'All.mat'],'ud2All', '-v7.3');