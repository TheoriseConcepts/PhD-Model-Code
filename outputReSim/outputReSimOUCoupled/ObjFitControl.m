function [SimControlAll, Sim2ControlAll, udAll, ud2All] = ObjFitControl(BestFitParams, DataControl, bb, aa, ObjNum)

%Begin Simulation

SimControlAll = zeros(size(BestFitParams,1),3713);
Sim2ControlAll = zeros(size(BestFitParams,1),3713);
...
SimControlAll(kk,:) = SimControl;

ud = XemburnSaveAll(Indx,:);
udAll(kk,:) = ud;

Sim2Control = X4Rep(Indx,:);
Sim2ControlAll(kk,:) = Sim2Control;
