...
vectorType2 = coder.typeof(1, [1 22], [false false]); % sets up an input that is a vector row with fixed size columns
...
codegen gamultiobjWendlingWhite -args {vectorType1, vectorType2}
