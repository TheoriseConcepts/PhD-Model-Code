...
vectorType2 = coder.typeof(1, [1 21], [false false]); % sets up an input that is a vector row with fixed size columns
...
codegen gamultiobjWendling -args {vectorType1, vectorType2}
